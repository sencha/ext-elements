...
export default class Ext_panel_Date extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_panel_Date.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_panel_Date.PROPERTIES()),
            events.concat(Ext_panel_Date.EVENTS())
        )
    }
