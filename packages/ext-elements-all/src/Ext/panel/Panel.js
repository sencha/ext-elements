...
export default class Ext_panel_Panel extends Ext_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_panel_Panel.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_panel_Panel.PROPERTIES()),
            events.concat(Ext_panel_Panel.EVENTS())
        )
    }
