...
export default class Ext_carousel_Carousel extends Ext_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_carousel_Carousel.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_carousel_Carousel.PROPERTIES()),
            events.concat(Ext_carousel_Carousel.EVENTS())
        )
    }
