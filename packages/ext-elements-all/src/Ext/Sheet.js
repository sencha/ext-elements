...
export default class Ext_Sheet extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Sheet.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Sheet.PROPERTIES()),
            events.concat(Ext_Sheet.EVENTS())
        )
    }
