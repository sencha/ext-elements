...
export default class Ext_dataview_listswiper_Item extends Ext_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_dataview_listswiper_Item.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_dataview_listswiper_Item.PROPERTIES()),
            events.concat(Ext_dataview_listswiper_Item.EVENTS())
        )
    }
