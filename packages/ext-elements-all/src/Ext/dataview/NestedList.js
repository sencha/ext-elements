...
export default class Ext_dataview_NestedList extends Ext_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_dataview_NestedList.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_dataview_NestedList.PROPERTIES()),
            events.concat(Ext_dataview_NestedList.EVENTS())
        )
    }
