...
export default class Ext_dataview_ChipView extends Ext_dataview_DataView {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_dataview_ChipView.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_dataview_ChipView.PROPERTIES()),
            events.concat(Ext_dataview_ChipView.EVENTS())
        )
    }
