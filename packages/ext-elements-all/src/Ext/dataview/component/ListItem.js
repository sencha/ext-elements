...
export default class Ext_dataview_component_ListItem extends Ext_dataview_DataItem {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_dataview_component_ListItem.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_dataview_component_ListItem.PROPERTIES()),
            events.concat(Ext_dataview_component_ListItem.EVENTS())
        )
    }
