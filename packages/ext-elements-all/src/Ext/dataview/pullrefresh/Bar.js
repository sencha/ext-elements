...
export default class Ext_dataview_pullrefresh_Bar extends Ext_dataview_pullrefresh_Item {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_dataview_pullrefresh_Bar.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_dataview_pullrefresh_Bar.PROPERTIES()),
            events.concat(Ext_dataview_pullrefresh_Bar.EVENTS())
        )
    }
