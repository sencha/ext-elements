...
export default class Ext_Dialog extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Dialog.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Dialog.PROPERTIES()),
            events.concat(Ext_Dialog.EVENTS())
        )
    }
