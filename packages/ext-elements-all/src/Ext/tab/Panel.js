...
export default class Ext_tab_Panel extends Ext_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_tab_Panel.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_tab_Panel.PROPERTIES()),
            events.concat(Ext_tab_Panel.EVENTS())
        )
    }
