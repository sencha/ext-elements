...
export default class Ext_calendar_panel_AbstractBase extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_calendar_panel_AbstractBase.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_calendar_panel_AbstractBase.PROPERTIES()),
            events.concat(Ext_calendar_panel_AbstractBase.EVENTS())
        )
    }
