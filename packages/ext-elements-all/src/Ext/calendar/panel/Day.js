...
export default class Ext_calendar_panel_Day extends Ext_calendar_panel_Days {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_calendar_panel_Day.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_calendar_panel_Day.PROPERTIES()),
            events.concat(Ext_calendar_panel_Day.EVENTS())
        )
    }
