...
export default class Ext_calendar_form_Edit extends Ext_calendar_form_Form {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_calendar_form_Edit.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_calendar_form_Edit.PROPERTIES()),
            events.concat(Ext_calendar_form_Edit.EVENTS())
        )
    }
