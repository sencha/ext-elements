...
export default class Ext_Chip extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Chip.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Chip.PROPERTIES()),
            events.concat(Ext_Chip.EVENTS())
        )
    }
