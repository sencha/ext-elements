...
export default class Ext_Window extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Window.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Window.PROPERTIES()),
            events.concat(Ext_Window.EVENTS())
        )
    }
