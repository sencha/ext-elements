...
export default class Ext_pivot_plugin_configurator_Container extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_pivot_plugin_configurator_Container.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_pivot_plugin_configurator_Container.PROPERTIES()),
            events.concat(Ext_pivot_plugin_configurator_Container.EVENTS())
        )
    }
