...
export default class Ext_pivot_plugin_configurator_Settings extends Ext_form_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_pivot_plugin_configurator_Settings.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_pivot_plugin_configurator_Settings.PROPERTIES()),
            events.concat(Ext_pivot_plugin_configurator_Settings.EVENTS())
        )
    }
