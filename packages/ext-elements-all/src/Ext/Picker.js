...
export default class Ext_Picker extends Ext_Sheet {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Picker.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Picker.PROPERTIES()),
            events.concat(Ext_Picker.EVENTS())
        )
    }
