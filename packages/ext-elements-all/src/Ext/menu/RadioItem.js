...
export default class Ext_menu_RadioItem extends Ext_menu_CheckItem {
...
{name:'beforecheckchange',parameters:'sender,checked'},
...
{name:'checkchange',parameters:'sender,checked'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_menu_RadioItem.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_menu_RadioItem.PROPERTIES()),
            events.concat(Ext_menu_RadioItem.EVENTS())
        )
    }
