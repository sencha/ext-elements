...
export default class Ext_grid_menu_SortDesc extends Ext_menu_RadioItem {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_menu_SortDesc.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_menu_SortDesc.PROPERTIES()),
            events.concat(Ext_grid_menu_SortDesc.EVENTS())
        )
    }
