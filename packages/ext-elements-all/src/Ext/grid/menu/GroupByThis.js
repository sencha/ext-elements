...
export default class Ext_grid_menu_GroupByThis extends Ext_menu_Item {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_menu_GroupByThis.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_menu_GroupByThis.PROPERTIES()),
            events.concat(Ext_grid_menu_GroupByThis.EVENTS())
        )
    }
