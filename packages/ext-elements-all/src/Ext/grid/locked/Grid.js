...
export default class Ext_grid_locked_Grid extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_locked_Grid.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_locked_Grid.PROPERTIES()),
            events.concat(Ext_grid_locked_Grid.EVENTS())
        )
    }
