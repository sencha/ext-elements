...
export default class Ext_grid_locked_Region extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_locked_Region.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_locked_Region.PROPERTIES()),
            events.concat(Ext_grid_locked_Region.EVENTS())
        )
    }
