...
export default class Ext_grid_rowedit_Cell extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_rowedit_Cell.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_rowedit_Cell.PROPERTIES()),
            events.concat(Ext_grid_rowedit_Cell.EVENTS())
        )
    }
