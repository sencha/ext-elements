...
export default class Ext_grid_rowedit_Bar extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_rowedit_Bar.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_rowedit_Bar.PROPERTIES()),
            events.concat(Ext_grid_rowedit_Bar.EVENTS())
        )
    }
