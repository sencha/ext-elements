...
export default class Ext_grid_HeaderContainer extends Ext_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_HeaderContainer.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_HeaderContainer.PROPERTIES()),
            events.concat(Ext_grid_HeaderContainer.EVENTS())
        )
    }
