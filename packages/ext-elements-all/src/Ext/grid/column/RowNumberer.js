...
export default class Ext_grid_column_RowNumberer extends Ext_grid_column_Number {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_column_RowNumberer.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_column_RowNumberer.PROPERTIES()),
            events.concat(Ext_grid_column_RowNumberer.EVENTS())
        )
    }
