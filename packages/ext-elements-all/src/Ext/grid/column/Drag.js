...
export default class Ext_grid_column_Drag extends Ext_grid_column_Column {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_column_Drag.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_column_Drag.PROPERTIES()),
            events.concat(Ext_grid_column_Drag.EVENTS())
        )
    }
