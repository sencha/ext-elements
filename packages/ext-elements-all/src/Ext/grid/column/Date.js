...
export default class Ext_grid_column_Date extends Ext_grid_column_Column {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_column_Date.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_column_Date.PROPERTIES()),
            events.concat(Ext_grid_column_Date.EVENTS())
        )
    }
