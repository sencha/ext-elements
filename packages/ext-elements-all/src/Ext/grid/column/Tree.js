...
export default class Ext_grid_column_Tree extends Ext_grid_column_Column {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_column_Tree.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_column_Tree.PROPERTIES()),
            events.concat(Ext_grid_column_Tree.EVENTS())
        )
    }
