...
export default class Ext_grid_LockedGrid extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_LockedGrid.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_LockedGrid.PROPERTIES()),
            events.concat(Ext_grid_LockedGrid.EVENTS())
        )
    }
