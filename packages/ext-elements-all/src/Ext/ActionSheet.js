...
export default class Ext_ActionSheet extends Ext_Sheet {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ActionSheet.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ActionSheet.PROPERTIES()),
            events.concat(Ext_ActionSheet.EVENTS())
        )
    }
