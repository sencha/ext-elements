...
export default class Ext_Mask extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Mask.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Mask.PROPERTIES()),
            events.concat(Ext_Mask.EVENTS())
        )
    }
