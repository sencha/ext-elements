...
export default class Ext_window_Window extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_window_Window.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_window_Window.PROPERTIES()),
            events.concat(Ext_window_Window.EVENTS())
        )
    }
