...
export default class Ext_froala_EditorField extends Ext_field_Container {
...
{name:'change',parameters:'sender,the'},
...
{name:'ready',parameters:'sender,the'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_froala_EditorField.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_froala_EditorField.PROPERTIES()),
            events.concat(Ext_froala_EditorField.EVENTS())
        )
    }
