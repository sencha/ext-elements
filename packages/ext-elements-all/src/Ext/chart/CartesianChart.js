...
export default class Ext_chart_CartesianChart extends Ext_chart_AbstractChart {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_chart_CartesianChart.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_chart_CartesianChart.PROPERTIES()),
            events.concat(Ext_chart_CartesianChart.EVENTS())
        )
    }
