...
export default class Ext_chart_PolarChart extends Ext_chart_AbstractChart {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_chart_PolarChart.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_chart_PolarChart.PROPERTIES()),
            events.concat(Ext_chart_PolarChart.EVENTS())
        )
    }
