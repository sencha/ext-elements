...
export default class Ext_chart_Legend extends Ext_chart_legend_LegendBase {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_chart_Legend.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_chart_Legend.PROPERTIES()),
            events.concat(Ext_chart_Legend.EVENTS())
        )
    }
