...
export default class Ext_Map extends Ext_Container {
...
{name:'centerchange',parameters:'sender,map,center'},
...
{name:'maprender',parameters:'sender,map'},
...
{name:'typechange',parameters:'sender,map,mapType'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Map.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Map.PROPERTIES()),
            events.concat(Ext_Map.EVENTS())
        )
    }
