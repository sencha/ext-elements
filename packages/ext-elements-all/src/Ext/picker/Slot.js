...
export default class Ext_picker_Slot extends Ext_dataview_DataView {
...
{name:'slotpick',parameters:'sender,value,node'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_picker_Slot.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_picker_Slot.PROPERTIES()),
            events.concat(Ext_picker_Slot.EVENTS())
        )
    }
