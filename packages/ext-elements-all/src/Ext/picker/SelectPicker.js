...
export default class Ext_picker_SelectPicker extends Ext_picker_Picker {
...
{name:'change',parameters:'sender,values'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_picker_SelectPicker.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_picker_SelectPicker.PROPERTIES()),
            events.concat(Ext_picker_SelectPicker.EVENTS())
        )
    }
