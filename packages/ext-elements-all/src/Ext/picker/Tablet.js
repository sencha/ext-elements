...
export default class Ext_picker_Tablet extends Ext_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_picker_Tablet.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_picker_Tablet.PROPERTIES()),
            events.concat(Ext_picker_Tablet.EVENTS())
        )
    }
