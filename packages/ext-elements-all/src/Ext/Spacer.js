...
export default class Ext_Spacer extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Spacer.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Spacer.PROPERTIES()),
            events.concat(Ext_Spacer.EVENTS())
        )
    }
