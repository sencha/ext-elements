...
export default class Ext_field_DatePickerNative extends Ext_field_Date {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_DatePickerNative.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_DatePickerNative.PROPERTIES()),
            events.concat(Ext_field_DatePickerNative.EVENTS())
        )
    }
