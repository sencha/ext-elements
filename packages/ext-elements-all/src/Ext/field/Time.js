...
export default class Ext_field_Time extends Ext_field_Picker {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Time.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Time.PROPERTIES()),
            events.concat(Ext_field_Time.EVENTS())
        )
    }
