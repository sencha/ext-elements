...
export default class Ext_field_Hidden extends Ext_field_Input {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Hidden.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Hidden.PROPERTIES()),
            events.concat(Ext_field_Hidden.EVENTS())
        )
    }
