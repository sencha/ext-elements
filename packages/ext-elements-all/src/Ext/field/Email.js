...
export default class Ext_field_Email extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Email.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Email.PROPERTIES()),
            events.concat(Ext_field_Email.EVENTS())
        )
    }
