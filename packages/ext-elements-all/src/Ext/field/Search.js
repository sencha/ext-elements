...
export default class Ext_field_Search extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Search.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Search.PROPERTIES()),
            events.concat(Ext_field_Search.EVENTS())
        )
    }
