...
export default class Ext_field_File extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_File.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_File.PROPERTIES()),
            events.concat(Ext_field_File.EVENTS())
        )
    }
