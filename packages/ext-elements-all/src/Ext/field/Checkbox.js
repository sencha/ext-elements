...
export default class Ext_field_Checkbox extends Ext_field_Input {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Checkbox.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Checkbox.PROPERTIES()),
            events.concat(Ext_field_Checkbox.EVENTS())
        )
    }
