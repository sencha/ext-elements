...
export default class Ext_field_SingleSlider extends Ext_field_Slider {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_SingleSlider.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_SingleSlider.PROPERTIES()),
            events.concat(Ext_field_SingleSlider.EVENTS())
        )
    }
