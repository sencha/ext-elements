...
export default class Ext_field_Url extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Url.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Url.PROPERTIES()),
            events.concat(Ext_field_Url.EVENTS())
        )
    }
