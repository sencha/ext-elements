...
export default class Ext_field_Select extends Ext_field_Picker {
...
{name:'select',parameters:'sender,newValue'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Select.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Select.PROPERTIES()),
            events.concat(Ext_field_Select.EVENTS())
        )
    }
