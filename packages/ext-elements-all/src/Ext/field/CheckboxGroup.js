...
export default class Ext_field_CheckboxGroup extends Ext_field_FieldGroupContainer {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_CheckboxGroup.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_CheckboxGroup.PROPERTIES()),
            events.concat(Ext_field_CheckboxGroup.EVENTS())
        )
    }
