...
export default class Ext_field_ComboBox extends Ext_field_Select {
...
{name:'beforepickercreate',parameters:'sender,newValue'},
...
{name:'pickercreate',parameters:'sender,picker'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_ComboBox.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_ComboBox.PROPERTIES()),
            events.concat(Ext_field_ComboBox.EVENTS())
        )
    }
