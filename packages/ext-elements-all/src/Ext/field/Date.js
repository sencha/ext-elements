...
export default class Ext_field_Date extends Ext_field_Picker {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Date.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Date.PROPERTIES()),
            events.concat(Ext_field_Date.EVENTS())
        )
    }
