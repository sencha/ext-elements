...
export default class Ext_field_Field extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Field.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Field.PROPERTIES()),
            events.concat(Ext_field_Field.EVENTS())
        )
    }
