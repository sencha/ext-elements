...
export default class Ext_field_Text extends Ext_field_Input {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Text.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Text.PROPERTIES()),
            events.concat(Ext_field_Text.EVENTS())
        )
    }
