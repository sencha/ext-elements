...
export default class Ext_field_Number extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_field_Number.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_field_Number.PROPERTIES()),
            events.concat(Ext_field_Number.EVENTS())
        )
    }
