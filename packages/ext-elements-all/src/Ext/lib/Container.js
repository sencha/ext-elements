...
export default class Ext_lib_Container extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_lib_Container.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_lib_Container.PROPERTIES()),
            events.concat(Ext_lib_Container.EVENTS())
        )
    }
