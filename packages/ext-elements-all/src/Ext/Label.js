...
export default class Ext_Label extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Label.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Label.PROPERTIES()),
            events.concat(Ext_Label.EVENTS())
        )
    }
