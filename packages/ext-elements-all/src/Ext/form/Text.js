...
export default class Ext_form_Text extends Ext_field_Input {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Text.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Text.PROPERTIES()),
            events.concat(Ext_form_Text.EVENTS())
        )
    }
