...
export default class Ext_form_FormPanel extends Ext_field_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_FormPanel.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_FormPanel.PROPERTIES()),
            events.concat(Ext_form_FormPanel.EVENTS())
        )
    }
