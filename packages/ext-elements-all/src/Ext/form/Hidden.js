...
export default class Ext_form_Hidden extends Ext_field_Input {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Hidden.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Hidden.PROPERTIES()),
            events.concat(Ext_form_Hidden.EVENTS())
        )
    }
