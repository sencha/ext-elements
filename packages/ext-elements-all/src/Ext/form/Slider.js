...
export default class Ext_form_Slider extends Ext_field_Field {
...
{name:'drag',parameters:'sender,sl,thumb,e'},
{name:'dragchange',parameters:'me,sl,thumb,newValue,oldValue'},
{name:'dragend',parameters:'sender,sl,thumb,value,e'},
{name:'dragstart',parameters:'sender,sl,thumb,value,e'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Slider.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Slider.PROPERTIES()),
            events.concat(Ext_form_Slider.EVENTS())
        )
    }
