...
export default class Ext_form_TextArea extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_TextArea.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_TextArea.PROPERTIES()),
            events.concat(Ext_form_TextArea.EVENTS())
        )
    }
