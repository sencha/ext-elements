...
export default class Ext_form_Display extends Ext_field_Field {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Display.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Display.PROPERTIES()),
            events.concat(Ext_form_Display.EVENTS())
        )
    }
