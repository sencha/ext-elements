...
export default class Ext_form_Checkbox extends Ext_field_Input {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Checkbox.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Checkbox.PROPERTIES()),
            events.concat(Ext_form_Checkbox.EVENTS())
        )
    }
