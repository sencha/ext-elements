...
export default class Ext_form_Url extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Url.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Url.PROPERTIES()),
            events.concat(Ext_form_Url.EVENTS())
        )
    }
