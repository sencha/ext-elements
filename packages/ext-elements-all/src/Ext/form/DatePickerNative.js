...
export default class Ext_form_DatePickerNative extends Ext_field_Date {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_DatePickerNative.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_DatePickerNative.PROPERTIES()),
            events.concat(Ext_form_DatePickerNative.EVENTS())
        )
    }
