...
export default class Ext_form_Search extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Search.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Search.PROPERTIES()),
            events.concat(Ext_form_Search.EVENTS())
        )
    }
