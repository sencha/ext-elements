...
export default class Ext_form_Email extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Email.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Email.PROPERTIES()),
            events.concat(Ext_form_Email.EVENTS())
        )
    }
