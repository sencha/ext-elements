...
export default class Ext_form_Password extends Ext_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_Password.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_Password.PROPERTIES()),
            events.concat(Ext_form_Password.EVENTS())
        )
    }
