...
export default class Ext_draw_ContainerBase extends Ext_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_draw_ContainerBase.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_draw_ContainerBase.PROPERTIES()),
            events.concat(Ext_draw_ContainerBase.EVENTS())
        )
    }
