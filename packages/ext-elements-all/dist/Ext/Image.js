...
function (_Ext_Component) {
  ...
  Ext_Image.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Image.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_Image.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_Image, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_Image.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_Image.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_Image.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Image(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_Image.PROPERTIES()), events.concat(Ext_Image.EVENTS())) || this;
  }

  var _proto = Ext_Image.prototype;
