...
var Ext_calendar_header_Base =
/*#__PURE__*/
function (_Ext_Gadget) {
  _inheritsLoose(Ext_calendar_header_Base, _Ext_Gadget);

  Ext_calendar_header_Base.PROPERTIES = function PROPERTIES() {
  ...
  Ext_calendar_header_Base.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_calendar_header_Base.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_calendar_header_Base.PROPERTIES());
    return Ext_Gadget.getProperties(properties);
  };

  Ext_calendar_header_Base.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_calendar_header_Base, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Gadget.observedAttributes; //for (var property in Ext_calendar_header_Base.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_calendar_header_Base(properties, events) {
    return _Ext_Gadget.call(this, properties.concat(Ext_calendar_header_Base.PROPERTIES()), events.concat(Ext_calendar_header_Base.EVENTS())) || this;
  }

  var _proto = Ext_calendar_header_Base.prototype;
...
export { Ext_calendar_header_Base as default };