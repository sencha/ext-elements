...
var Ext_calendar_panel_AbstractBase =
/*#__PURE__*/
function (_Ext_Panel) {
  _inheritsLoose(Ext_calendar_panel_AbstractBase, _Ext_Panel);

  Ext_calendar_panel_AbstractBase.PROPERTIES = function PROPERTIES() {
  ...
  Ext_calendar_panel_AbstractBase.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_calendar_panel_AbstractBase.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_calendar_panel_AbstractBase.PROPERTIES());
    return Ext_Panel.getProperties(properties);
  };

  Ext_calendar_panel_AbstractBase.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_calendar_panel_AbstractBase, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Panel.observedAttributes; //for (var property in Ext_calendar_panel_AbstractBase.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_calendar_panel_AbstractBase.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_calendar_panel_AbstractBase.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_calendar_panel_AbstractBase(properties, events) {
    return _Ext_Panel.call(this, properties.concat(Ext_calendar_panel_AbstractBase.PROPERTIES()), events.concat(Ext_calendar_panel_AbstractBase.EVENTS())) || this;
  }

  var _proto = Ext_calendar_panel_AbstractBase.prototype;
...
export { Ext_calendar_panel_AbstractBase as default };