...
function (_Ext_Gadget) {
  ...
  _createClass(Ext_calendar_EventBase, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Gadget.observedAttributes; //for (var property in Ext_calendar_EventBase.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
