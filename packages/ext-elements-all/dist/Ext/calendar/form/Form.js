...
var Ext_calendar_form_Form =
/*#__PURE__*/
function (_Ext_calendar_form_Ab) {
  _inheritsLoose(Ext_calendar_form_Form, _Ext_calendar_form_Ab);

  Ext_calendar_form_Form.PROPERTIES = function PROPERTIES() {
  ...
  Ext_calendar_form_Form.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_calendar_form_Form.getProperties = function getProperties(properties) {
  ...
  Ext_calendar_form_Form.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_calendar_form_Form, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_calendar_form_Ab.observedAttributes; //for (var property in Ext_calendar_form_Form.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_calendar_form_Form(properties, events) {
    return _Ext_calendar_form_Ab.call(this, properties.concat(Ext_calendar_form_Form.PROPERTIES()), events.concat(Ext_calendar_form_Form.EVENTS())) || this;
  }

  var _proto = Ext_calendar_form_Form.prototype;
...
export { Ext_calendar_form_Form as default };