...
function (_Ext_Component) {
  _inheritsLoose(Ext_IndexBar, _Ext_Component);

  Ext_IndexBar.PROPERTIES = function PROPERTIES() {
  ...
  Ext_IndexBar.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_IndexBar.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_IndexBar.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_IndexBar.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_IndexBar, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_IndexBar.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_IndexBar.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_IndexBar.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_IndexBar(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_IndexBar.PROPERTIES()), events.concat(Ext_IndexBar.EVENTS())) || this;
  }

  var _proto = Ext_IndexBar.prototype;
...
export { Ext_IndexBar as default };