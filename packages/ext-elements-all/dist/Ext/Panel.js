...
function (_Ext_Container) {
  _inheritsLoose(Ext_Panel, _Ext_Container);

  Ext_Panel.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Panel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_Panel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Panel.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_Panel.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_Panel, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_Panel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_Panel(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_Panel.PROPERTIES()), events.concat(Ext_Panel.EVENTS())) || this;
  }

  var _proto = Ext_Panel.prototype;
