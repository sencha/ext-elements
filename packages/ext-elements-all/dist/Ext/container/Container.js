...
var Ext_container_Container =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_container_Container, _Ext_Component);

  Ext_container_Container.PROPERTIES = function PROPERTIES() {
  ...
  Ext_container_Container.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_container_Container.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_container_Container.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_container_Container.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_container_Container, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_container_Container.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_container_Container.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_container_Container.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_container_Container(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_container_Container.PROPERTIES()), events.concat(Ext_container_Container.EVENTS())) || this;
  }

  var _proto = Ext_container_Container.prototype;
...
export { Ext_container_Container as default };