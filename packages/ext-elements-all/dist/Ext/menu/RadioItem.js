...
function (_Ext_menu_CheckItem) {
  ...
  Ext_menu_RadioItem.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_menu_RadioItem, null, [{
    ...
    get: function get() {
      ...
      Ext_menu_RadioItem.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_menu_RadioItem(properties, events) {
    return _Ext_menu_CheckItem.call(this, properties.concat(Ext_menu_RadioItem.PROPERTIES()), events.concat(Ext_menu_RadioItem.EVENTS())) || this;
  }

  var _proto = Ext_menu_RadioItem.prototype;
...
export { Ext_menu_RadioItem as default };