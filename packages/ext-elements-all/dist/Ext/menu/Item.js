...
function (_Ext_Component) {
  _inheritsLoose(Ext_menu_Item, _Ext_Component);

  Ext_menu_Item.PROPERTIES = function PROPERTIES() {
  ...
  Ext_menu_Item.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_menu_Item.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_menu_Item.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_menu_Item.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_menu_Item, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_menu_Item.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_menu_Item.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_menu_Item.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_menu_Item(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_menu_Item.PROPERTIES()), events.concat(Ext_menu_Item.EVENTS())) || this;
  }

  var _proto = Ext_menu_Item.prototype;
...
export { Ext_menu_Item as default };