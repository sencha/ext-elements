...
var Ext_menu_Separator =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_menu_Separator, _Ext_Component);
  ...
  _createClass(Ext_menu_Separator, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_menu_Separator.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_menu_Separator(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_menu_Separator.PROPERTIES()), events.concat(Ext_menu_Separator.EVENTS())) || this;
  }
