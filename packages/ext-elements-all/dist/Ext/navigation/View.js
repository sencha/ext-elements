...
var Ext_navigation_View =
/*#__PURE__*/
function (_Ext_Container) {
  _inheritsLoose(Ext_navigation_View, _Ext_Container);

  Ext_navigation_View.PROPERTIES = function PROPERTIES() {
  ...
  Ext_navigation_View.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_navigation_View.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_navigation_View.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_navigation_View.getEvents = function getEvents(events) {
    events = events.concat(Ext_navigation_View.EVENTS());
  ...
  _createClass(Ext_navigation_View, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_navigation_View.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_navigation_View.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_navigation_View.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_navigation_View(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_navigation_View.PROPERTIES()), events.concat(Ext_navigation_View.EVENTS())) || this;
  }

  var _proto = Ext_navigation_View.prototype;
  ...
  return Ext_navigation_View;
}(Ext_Container);

export { Ext_navigation_View as default };