...
function (_Ext_Component) {
  _inheritsLoose(Ext_Label, _Ext_Component);

  Ext_Label.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Label.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_Label.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Label.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_Label.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_Label, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_Label.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_Label.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_Label.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Label(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_Label.PROPERTIES()), events.concat(Ext_Label.EVENTS())) || this;
  }

  var _proto = Ext_Label.prototype;
