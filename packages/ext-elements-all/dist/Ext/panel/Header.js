...
function (_Ext_Container) {
  ...
  _createClass(Ext_panel_Header, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_panel_Header.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_panel_Header(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_panel_Header.PROPERTIES()), events.concat(Ext_panel_Header.EVENTS())) || this;
  }
