...
function (_Ext_Container) {
  _inheritsLoose(Ext_tab_Panel, _Ext_Container);
  ...
  _createClass(Ext_tab_Panel, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_tab_Panel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_tab_Panel(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_tab_Panel.PROPERTIES()), events.concat(Ext_tab_Panel.EVENTS())) || this;
  }
