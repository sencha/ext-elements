...
var Ext_field_DatePickerNative =
/*#__PURE__*/
function (_Ext_field_Date) {
  _inheritsLoose(Ext_field_DatePickerNative, _Ext_field_Date);

  Ext_field_DatePickerNative.PROPERTIES = function PROPERTIES() {
  ...
  Ext_field_DatePickerNative.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_field_DatePickerNative.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_DatePickerNative.PROPERTIES());
    return Ext_field_Date.getProperties(properties);
  };

  Ext_field_DatePickerNative.getEvents = function getEvents(events) {
    events = events.concat(Ext_field_DatePickerNative.EVENTS());
  ...
  _createClass(Ext_field_DatePickerNative, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Date.observedAttributes; //for (var property in Ext_field_DatePickerNative.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_field_DatePickerNative.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_field_DatePickerNative.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_field_DatePickerNative(properties, events) {
    return _Ext_field_Date.call(this, properties.concat(Ext_field_DatePickerNative.PROPERTIES()), events.concat(Ext_field_DatePickerNative.EVENTS())) || this;
  }

  var _proto = Ext_field_DatePickerNative.prototype;
  ...
  return Ext_field_DatePickerNative;
}(Ext_field_Date);

export { Ext_field_DatePickerNative as default };