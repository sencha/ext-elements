...
function (_Ext_field_Input) {
  _inheritsLoose(Ext_field_Text, _Ext_field_Input);

  Ext_field_Text.PROPERTIES = function PROPERTIES() {
  ...
  Ext_field_Text.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_field_Text.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_Text.PROPERTIES());
    return Ext_field_Input.getProperties(properties);
  };

  Ext_field_Text.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_field_Text, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Input.observedAttributes; //for (var property in Ext_field_Text.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_field_Text.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_field_Text.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_field_Text(properties, events) {
    return _Ext_field_Input.call(this, properties.concat(Ext_field_Text.PROPERTIES()), events.concat(Ext_field_Text.EVENTS())) || this;
  }

  var _proto = Ext_field_Text.prototype;
...
export { Ext_field_Text as default };