...
function (_Ext_field_Text) {
  ...
  Ext_field_Email.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_field_Email.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_Email.PROPERTIES());
  ...
  _createClass(Ext_field_Email, null, [{
    ...
    get: function get() {
      ...
      Ext_field_Email.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_field_Email(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_field_Email.PROPERTIES()), events.concat(Ext_field_Email.EVENTS())) || this;
  }

  var _proto = Ext_field_Email.prototype;
  ...
  return Ext_field_Email;
}(Ext_field_Text);

export { Ext_field_Email as default };