...
var Ext_field_DatePicker =
/*#__PURE__*/
function (_Ext_field_Picker) {
  _inheritsLoose(Ext_field_DatePicker, _Ext_field_Picker);

  Ext_field_DatePicker.PROPERTIES = function PROPERTIES() {
  ...
  Ext_field_DatePicker.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_field_DatePicker.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_DatePicker.PROPERTIES());
    return Ext_field_Picker.getProperties(properties);
  };

  Ext_field_DatePicker.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_field_DatePicker, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Picker.observedAttributes; //for (var property in Ext_field_DatePicker.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_field_DatePicker(properties, events) {
    return _Ext_field_Picker.call(this, properties.concat(Ext_field_DatePicker.PROPERTIES()), events.concat(Ext_field_DatePicker.EVENTS())) || this;
  }

  var _proto = Ext_field_DatePicker.prototype;
...
export { Ext_field_DatePicker as default };