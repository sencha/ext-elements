...
function (_Ext_field_Text) {
  _inheritsLoose(Ext_field_Url, _Ext_field_Text);

  Ext_field_Url.PROPERTIES = function PROPERTIES() {
  ...
  Ext_field_Url.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_field_Url.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_Url.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_field_Url.getEvents = function getEvents(events) {
    events = events.concat(Ext_field_Url.EVENTS());
  ...
  _createClass(Ext_field_Url, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_field_Url.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_field_Url.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_field_Url.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_field_Url(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_field_Url.PROPERTIES()), events.concat(Ext_field_Url.EVENTS())) || this;
  }

  var _proto = Ext_field_Url.prototype;
  ...
  return Ext_field_Url;
}(Ext_field_Text);

export { Ext_field_Url as default };