...
var Ext_field_CheckboxGroup =
/*#__PURE__*/
function (_Ext_field_FieldGroup) {
  _inheritsLoose(Ext_field_CheckboxGroup, _Ext_field_FieldGroup);

  Ext_field_CheckboxGroup.PROPERTIES = function PROPERTIES() {
  ...
  Ext_field_CheckboxGroup.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_field_CheckboxGroup.getProperties = function getProperties(properties) {
  ...
  Ext_field_CheckboxGroup.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_field_CheckboxGroup, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_FieldGroup.observedAttributes; //for (var property in Ext_field_CheckboxGroup.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_field_CheckboxGroup.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_field_CheckboxGroup.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_field_CheckboxGroup(properties, events) {
    return _Ext_field_FieldGroup.call(this, properties.concat(Ext_field_CheckboxGroup.PROPERTIES()), events.concat(Ext_field_CheckboxGroup.EVENTS())) || this;
  }

  var _proto = Ext_field_CheckboxGroup.prototype;
...
export { Ext_field_CheckboxGroup as default };