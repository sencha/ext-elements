...
function (_Ext_field_FieldGroup) {
  ...
  Ext_field_RadioGroup.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_field_RadioGroup.getProperties = function getProperties(properties) {
  ...
  Ext_field_RadioGroup.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_field_RadioGroup, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_FieldGroup.observedAttributes; //for (var property in Ext_field_RadioGroup.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_field_RadioGroup(properties, events) {
    return _Ext_field_FieldGroup.call(this, properties.concat(Ext_field_RadioGroup.PROPERTIES()), events.concat(Ext_field_RadioGroup.EVENTS())) || this;
  }

  var _proto = Ext_field_RadioGroup.prototype;
...
export { Ext_field_RadioGroup as default };