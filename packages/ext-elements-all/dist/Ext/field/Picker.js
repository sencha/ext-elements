...
function (_Ext_field_Text) {
  ...
  Ext_field_Picker.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_Picker.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_field_Picker.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_field_Picker, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_field_Picker.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_field_Picker.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_field_Picker.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_field_Picker(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_field_Picker.PROPERTIES()), events.concat(Ext_field_Picker.EVENTS())) || this;
  }

  var _proto = Ext_field_Picker.prototype;
...
export { Ext_field_Picker as default };