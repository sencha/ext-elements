...
var Ext_field_trigger_SpinUp =
/*#__PURE__*/
function (_Ext_field_trigger_Tr) {
  _inheritsLoose(Ext_field_trigger_SpinUp, _Ext_field_trigger_Tr);

  Ext_field_trigger_SpinUp.PROPERTIES = function PROPERTIES() {
  ...
  Ext_field_trigger_SpinUp.EVENTS = function EVENTS() {
    return [{
  ...
  Ext_field_trigger_SpinUp.getProperties = function getProperties(properties) {
  ...
  Ext_field_trigger_SpinUp.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_field_trigger_SpinUp, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_trigger_Tr.observedAttributes; //for (var property in Ext_field_trigger_SpinUp.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_field_trigger_SpinUp(properties, events) {
    return _Ext_field_trigger_Tr.call(this, properties.concat(Ext_field_trigger_SpinUp.PROPERTIES()), events.concat(Ext_field_trigger_SpinUp.EVENTS())) || this;
  }

  var _proto = Ext_field_trigger_SpinUp.prototype;
...
export { Ext_field_trigger_SpinUp as default };