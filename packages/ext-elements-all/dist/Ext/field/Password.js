...
var Ext_field_Password =
/*#__PURE__*/
function (_Ext_field_Text) {
  _inheritsLoose(Ext_field_Password, _Ext_field_Text);

  Ext_field_Password.PROPERTIES = function PROPERTIES() {
  ...
  Ext_field_Password.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_field_Password.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_Password.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_field_Password.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_field_Password, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_field_Password.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_field_Password(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_field_Password.PROPERTIES()), events.concat(Ext_field_Password.EVENTS())) || this;
  }

  var _proto = Ext_field_Password.prototype;
  ...
  return Ext_field_Password;
}(Ext_field_Text);

export { Ext_field_Password as default };