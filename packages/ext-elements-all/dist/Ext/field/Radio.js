...
function (_Ext_field_Checkbox) {
  _inheritsLoose(Ext_field_Radio, _Ext_field_Checkbox);

  Ext_field_Radio.PROPERTIES = function PROPERTIES() {
  ...
  Ext_field_Radio.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_field_Radio.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_Radio.PROPERTIES());
  ...
  _createClass(Ext_field_Radio, null, [{
    ...
    get: function get() {
      ...
      Ext_field_Radio.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_field_Radio(properties, events) {
    return _Ext_field_Checkbox.call(this, properties.concat(Ext_field_Radio.PROPERTIES()), events.concat(Ext_field_Radio.EVENTS())) || this;
  }

  var _proto = Ext_field_Radio.prototype;

  _proto.connectedCallback = function connectedCallback() {
    _Ext_field_Checkbox.prototype.connectedCallback.call(this);
  };

  _proto.attributeChangedCallback = function attributeChangedCallback(attrName, oldVal, newVal) {
    _Ext_field_Checkbox.prototype.attributeChangedCallback.call(this, attrName, oldVal, newVal);
  };

  return Ext_field_Radio;
}(Ext_field_Checkbox);

export { Ext_field_Radio as default };