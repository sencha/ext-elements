...
function (_Ext_field_Text) {
  ...
  Ext_field_Number.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_field_Number.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_field_Number.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_field_Number, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_field_Number.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_field_Number.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_field_Number.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_field_Number(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_field_Number.PROPERTIES()), events.concat(Ext_field_Number.EVENTS())) || this;
  }

  var _proto = Ext_field_Number.prototype;
...
export { Ext_field_Number as default };