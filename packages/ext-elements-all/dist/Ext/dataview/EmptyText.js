...
var Ext_dataview_EmptyText =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_dataview_EmptyText, _Ext_Component);

  Ext_dataview_EmptyText.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dataview_EmptyText.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_dataview_EmptyText.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dataview_EmptyText.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_dataview_EmptyText.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_EmptyText, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_dataview_EmptyText.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dataview_EmptyText.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dataview_EmptyText.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_EmptyText(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_dataview_EmptyText.PROPERTIES()), events.concat(Ext_dataview_EmptyText.EVENTS())) || this;
  }

  var _proto = Ext_dataview_EmptyText.prototype;
...
export { Ext_dataview_EmptyText as default };