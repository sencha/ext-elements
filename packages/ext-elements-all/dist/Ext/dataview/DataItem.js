...
var Ext_dataview_DataItem =
/*#__PURE__*/
function (_Ext_Container) {
  _inheritsLoose(Ext_dataview_DataItem, _Ext_Container);

  Ext_dataview_DataItem.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dataview_DataItem.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_dataview_DataItem.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dataview_DataItem.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_dataview_DataItem.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_DataItem, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_dataview_DataItem.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dataview_DataItem.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dataview_DataItem.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_DataItem(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_dataview_DataItem.PROPERTIES()), events.concat(Ext_dataview_DataItem.EVENTS())) || this;
  }

  var _proto = Ext_dataview_DataItem.prototype;
...
export { Ext_dataview_DataItem as default };