...
function (_Ext_dataview_DataIte) {
  ...
  Ext_dataview_ListItem.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_dataview_ListItem.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dataview_ListItem.PROPERTIES());
    return Ext_dataview_DataItem.getProperties(properties);
  };

  Ext_dataview_ListItem.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_ListItem, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_dataview_DataIte.observedAttributes; //for (var property in Ext_dataview_ListItem.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_dataview_ListItem(properties, events) {
    return _Ext_dataview_DataIte.call(this, properties.concat(Ext_dataview_ListItem.PROPERTIES()), events.concat(Ext_dataview_ListItem.EVENTS())) || this;
  }

  var _proto = Ext_dataview_ListItem.prototype;
...
export { Ext_dataview_ListItem as default };