...
var Ext_dataview_ListItemPlaceholder =
/*#__PURE__*/
function (_Ext_dataview_SimpleL) {
  _inheritsLoose(Ext_dataview_ListItemPlaceholder, _Ext_dataview_SimpleL);

  Ext_dataview_ListItemPlaceholder.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dataview_ListItemPlaceholder.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_dataview_ListItemPlaceholder.getProperties = function getProperties(properties) {
  ...
  function Ext_dataview_ListItemPlaceholder(properties, events) {
    return _Ext_dataview_SimpleL.call(this, properties.concat(Ext_dataview_ListItemPlaceholder.PROPERTIES()), events.concat(Ext_dataview_ListItemPlaceholder.EVENTS())) || this;
  }

  var _proto = Ext_dataview_ListItemPlaceholder.prototype;
...
export { Ext_dataview_ListItemPlaceholder as default };