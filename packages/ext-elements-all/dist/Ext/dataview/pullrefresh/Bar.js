...
var Ext_dataview_pullrefresh_Bar =
/*#__PURE__*/
function (_Ext_dataview_pullref) {
  ...
  Ext_dataview_pullrefresh_Bar.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_dataview_pullrefresh_Bar.getProperties = function getProperties(properties) {
  ...
  Ext_dataview_pullrefresh_Bar.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_pullrefresh_Bar, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_dataview_pullref.observedAttributes; //for (var property in Ext_dataview_pullrefresh_Bar.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dataview_pullrefresh_Bar.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dataview_pullrefresh_Bar.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_pullrefresh_Bar(properties, events) {
    return _Ext_dataview_pullref.call(this, properties.concat(Ext_dataview_pullrefresh_Bar.PROPERTIES()), events.concat(Ext_dataview_pullrefresh_Bar.EVENTS())) || this;
  }

  var _proto = Ext_dataview_pullrefresh_Bar.prototype;
...
export { Ext_dataview_pullrefresh_Bar as default };