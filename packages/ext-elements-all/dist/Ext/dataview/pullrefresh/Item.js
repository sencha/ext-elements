...
var Ext_dataview_pullrefresh_Item =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_dataview_pullrefresh_Item, _Ext_Component);

  Ext_dataview_pullrefresh_Item.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dataview_pullrefresh_Item.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_dataview_pullrefresh_Item.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dataview_pullrefresh_Item.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_dataview_pullrefresh_Item.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_pullrefresh_Item, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_dataview_pullrefresh_Item.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dataview_pullrefresh_Item.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dataview_pullrefresh_Item.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_pullrefresh_Item(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_dataview_pullrefresh_Item.PROPERTIES()), events.concat(Ext_dataview_pullrefresh_Item.EVENTS())) || this;
  }

  var _proto = Ext_dataview_pullrefresh_Item.prototype;
...
export { Ext_dataview_pullrefresh_Item as default };