...
var Ext_dataview_listswiper_Item =
/*#__PURE__*/
function (_Ext_Container) {
  _inheritsLoose(Ext_dataview_listswiper_Item, _Ext_Container);

  Ext_dataview_listswiper_Item.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dataview_listswiper_Item.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_dataview_listswiper_Item.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dataview_listswiper_Item.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_dataview_listswiper_Item.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_listswiper_Item, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_dataview_listswiper_Item.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dataview_listswiper_Item.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dataview_listswiper_Item.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_listswiper_Item(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_dataview_listswiper_Item.PROPERTIES()), events.concat(Ext_dataview_listswiper_Item.EVENTS())) || this;
  }

  var _proto = Ext_dataview_listswiper_Item.prototype;
...
export { Ext_dataview_listswiper_Item as default };