...
var Ext_dataview_component_SimpleListItem =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_dataview_component_SimpleListItem, _Ext_Component);

  Ext_dataview_component_SimpleListItem.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dataview_component_SimpleListItem.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_dataview_component_SimpleListItem.getProperties = function getProperties(properties) {
  ...
  Ext_dataview_component_SimpleListItem.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_component_SimpleListItem, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_dataview_component_SimpleListItem.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dataview_component_SimpleListItem.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dataview_component_SimpleListItem.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_component_SimpleListItem(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_dataview_component_SimpleListItem.PROPERTIES()), events.concat(Ext_dataview_component_SimpleListItem.EVENTS())) || this;
  }

  var _proto = Ext_dataview_component_SimpleListItem.prototype;
...
export { Ext_dataview_component_SimpleListItem as default };