...
var Ext_dataview_ItemHeader =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_dataview_ItemHeader, _Ext_Component);

  Ext_dataview_ItemHeader.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dataview_ItemHeader.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_dataview_ItemHeader.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dataview_ItemHeader.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_dataview_ItemHeader.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_ItemHeader, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_dataview_ItemHeader.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dataview_ItemHeader.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dataview_ItemHeader.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_ItemHeader(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_dataview_ItemHeader.PROPERTIES()), events.concat(Ext_dataview_ItemHeader.EVENTS())) || this;
  }

  var _proto = Ext_dataview_ItemHeader.prototype;
...
export { Ext_dataview_ItemHeader as default };