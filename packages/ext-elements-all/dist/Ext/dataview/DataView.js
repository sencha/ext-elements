...
var Ext_dataview_DataView =
/*#__PURE__*/
function (_Ext_dataview_Abstrac) {
  _inheritsLoose(Ext_dataview_DataView, _Ext_dataview_Abstrac);

  Ext_dataview_DataView.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dataview_DataView.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_dataview_DataView.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dataview_DataView.PROPERTIES());
    return Ext_dataview_Abstract.getProperties(properties);
  };

  Ext_dataview_DataView.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dataview_DataView, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_dataview_Abstrac.observedAttributes; //for (var property in Ext_dataview_DataView.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dataview_DataView.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dataview_DataView.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_DataView(properties, events) {
    return _Ext_dataview_Abstrac.call(this, properties.concat(Ext_dataview_DataView.PROPERTIES()), events.concat(Ext_dataview_DataView.EVENTS())) || this;
  }

  var _proto = Ext_dataview_DataView.prototype;
...
export { Ext_dataview_DataView as default };