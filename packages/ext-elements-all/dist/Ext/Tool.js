...
function (_Ext_Component) {
  ...
  Ext_Tool.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Tool.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_Tool.getEvents = function getEvents(events) {
    events = events.concat(Ext_Tool.EVENTS());
  ...
  _createClass(Ext_Tool, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_Tool.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_Tool.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_Tool.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Tool(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_Tool.PROPERTIES()), events.concat(Ext_Tool.EVENTS())) || this;
  }

  var _proto = Ext_Tool.prototype;
