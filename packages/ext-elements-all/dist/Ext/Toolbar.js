...
function (_Ext_Container) {
  _inheritsLoose(Ext_Toolbar, _Ext_Container);

  Ext_Toolbar.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Toolbar.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_Toolbar.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Toolbar.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_Toolbar.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_Toolbar, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_Toolbar.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_Toolbar.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_Toolbar.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Toolbar(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_Toolbar.PROPERTIES()), events.concat(Ext_Toolbar.EVENTS())) || this;
  }

  var _proto = Ext_Toolbar.prototype;
