...
function (_Ext_Panel) {
  ...
  Ext_pivot_plugin_configurator_Container.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_pivot_plugin_configurator_Container.PROPERTIES());
    return Ext_Panel.getProperties(properties);
  };

  Ext_pivot_plugin_configurator_Container.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_pivot_plugin_configurator_Container, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Panel.observedAttributes; //for (var property in Ext_pivot_plugin_configurator_Container.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_pivot_plugin_configurator_Container.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_pivot_plugin_configurator_Container.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_pivot_plugin_configurator_Container(properties, events) {
    return _Ext_Panel.call(this, properties.concat(Ext_pivot_plugin_configurator_Container.PROPERTIES()), events.concat(Ext_pivot_plugin_configurator_Container.EVENTS())) || this;
  }

  var _proto = Ext_pivot_plugin_configurator_Container.prototype;
...
export { Ext_pivot_plugin_configurator_Container as default };