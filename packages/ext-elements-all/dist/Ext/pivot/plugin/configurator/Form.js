...
var Ext_pivot_plugin_configurator_Form =
/*#__PURE__*/
function (_Ext_form_Panel) {
  _inheritsLoose(Ext_pivot_plugin_configurator_Form, _Ext_form_Panel);

  Ext_pivot_plugin_configurator_Form.PROPERTIES = function PROPERTIES() {
  ...
  Ext_pivot_plugin_configurator_Form.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_pivot_plugin_configurator_Form.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_pivot_plugin_configurator_Form.PROPERTIES());
    return Ext_form_Panel.getProperties(properties);
  };

  Ext_pivot_plugin_configurator_Form.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_pivot_plugin_configurator_Form, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_Panel.observedAttributes; //for (var property in Ext_pivot_plugin_configurator_Form.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_pivot_plugin_configurator_Form(properties, events) {
    return _Ext_form_Panel.call(this, properties.concat(Ext_pivot_plugin_configurator_Form.PROPERTIES()), events.concat(Ext_pivot_plugin_configurator_Form.EVENTS())) || this;
  }

  var _proto = Ext_pivot_plugin_configurator_Form.prototype;
...
export { Ext_pivot_plugin_configurator_Form as default };