...
function (_Ext_Component) {
  ...
  Ext_Title.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Title.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_Title.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_Title, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_Title.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_Title.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_Title.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Title(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_Title.PROPERTIES()), events.concat(Ext_Title.EVENTS())) || this;
  }

  var _proto = Ext_Title.prototype;
