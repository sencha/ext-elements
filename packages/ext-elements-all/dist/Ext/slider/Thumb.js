...
function (_Ext_Component) {
  ...
  _createClass(Ext_slider_Thumb, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_slider_Thumb.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_slider_Thumb(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_slider_Thumb.PROPERTIES()), events.concat(Ext_slider_Thumb.EVENTS())) || this;
  }
