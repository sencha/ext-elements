...
var Ext_window_Window =
/*#__PURE__*/
function (_Ext_Panel) {
  _inheritsLoose(Ext_window_Window, _Ext_Panel);

  Ext_window_Window.PROPERTIES = function PROPERTIES() {
  ...
  Ext_window_Window.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_window_Window.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_window_Window.PROPERTIES());
    return Ext_Panel.getProperties(properties);
  };

  Ext_window_Window.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_window_Window, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Panel.observedAttributes; //for (var property in Ext_window_Window.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_window_Window.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_window_Window.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_window_Window(properties, events) {
    return _Ext_Panel.call(this, properties.concat(Ext_window_Window.PROPERTIES()), events.concat(Ext_window_Window.EVENTS())) || this;
  }

  var _proto = Ext_window_Window.prototype;
...
export { Ext_window_Window as default };