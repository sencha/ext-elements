...
function (_Ext_Container) {
  ...
  Ext_ux_google_Map.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_google_Map.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_ux_google_Map.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_ux_google_Map, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_ux_google_Map.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_ux_google_Map(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_ux_google_Map.PROPERTIES()), events.concat(Ext_ux_google_Map.EVENTS())) || this;
  }

  var _proto = Ext_ux_google_Map.prototype;
  ...
  return Ext_ux_google_Map;
}(Ext_Container);

export { Ext_ux_google_Map as default };