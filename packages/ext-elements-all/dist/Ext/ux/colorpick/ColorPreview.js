...
var Ext_ux_colorpick_ColorPreview =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_ux_colorpick_ColorPreview, _Ext_Component);

  Ext_ux_colorpick_ColorPreview.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_colorpick_ColorPreview.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_ux_colorpick_ColorPreview.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_colorpick_ColorPreview.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_ux_colorpick_ColorPreview.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_ux_colorpick_ColorPreview, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_ux_colorpick_ColorPreview.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_colorpick_ColorPreview.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_colorpick_ColorPreview.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_colorpick_ColorPreview(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_ux_colorpick_ColorPreview.PROPERTIES()), events.concat(Ext_ux_colorpick_ColorPreview.EVENTS())) || this;
  }

  var _proto = Ext_ux_colorpick_ColorPreview.prototype;
...
export { Ext_ux_colorpick_ColorPreview as default };