...
function (_Ext_Container) {
  ...
  Ext_viewport_Default.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_viewport_Default.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_viewport_Default.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_viewport_Default, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_viewport_Default.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_viewport_Default.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_viewport_Default.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_viewport_Default(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_viewport_Default.PROPERTIES()), events.concat(Ext_viewport_Default.EVENTS())) || this;
  }

  var _proto = Ext_viewport_Default.prototype;
...
export { Ext_viewport_Default as default };