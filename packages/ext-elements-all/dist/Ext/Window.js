...
/*#__PURE__*/
function (_Ext_Panel) {
  _inheritsLoose(Ext_Window, _Ext_Panel);

  Ext_Window.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Window.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_Window.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Window.PROPERTIES());
  ...
  _createClass(Ext_Window, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Panel.observedAttributes; //for (var property in Ext_Window.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
      ...
      Ext_Window.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Window(properties, events) {
    return _Ext_Panel.call(this, properties.concat(Ext_Window.PROPERTIES()), events.concat(Ext_Window.EVENTS())) || this;
  }

  var _proto = Ext_Window.prototype;
