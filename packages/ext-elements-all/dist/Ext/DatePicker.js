...
function (_Ext_picker_Picker) {
  _inheritsLoose(Ext_DatePicker, _Ext_picker_Picker);
  ...
  _createClass(Ext_DatePicker, null, [{
    ...
    get: function get() {
      var attrs = _Ext_picker_Picker.observedAttributes; //for (var property in Ext_DatePicker.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_DatePicker(properties, events) {
    return _Ext_picker_Picker.call(this, properties.concat(Ext_DatePicker.PROPERTIES()), events.concat(Ext_DatePicker.EVENTS())) || this;
  }
