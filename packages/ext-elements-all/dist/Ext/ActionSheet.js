...
/*#__PURE__*/
function (_Ext_Sheet) {
  _inheritsLoose(Ext_ActionSheet, _Ext_Sheet);

  Ext_ActionSheet.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ActionSheet.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_ActionSheet.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ActionSheet.PROPERTIES());
    return Ext_Sheet.getProperties(properties);
  };

  Ext_ActionSheet.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_ActionSheet, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Sheet.observedAttributes; //for (var property in Ext_ActionSheet.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ActionSheet.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ActionSheet.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ActionSheet(properties, events) {
    return _Ext_Sheet.call(this, properties.concat(Ext_ActionSheet.PROPERTIES()), events.concat(Ext_ActionSheet.EVENTS())) || this;
  }

  var _proto = Ext_ActionSheet.prototype;
...
export { Ext_ActionSheet as default };