...
function (_Ext_Toolbar) {
  _inheritsLoose(Ext_TabBar, _Ext_Toolbar);

  Ext_TabBar.PROPERTIES = function PROPERTIES() {
  ...
  Ext_TabBar.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_TabBar.getProperties = function getProperties(properties) {
  ...
  function Ext_TabBar(properties, events) {
    return _Ext_Toolbar.call(this, properties.concat(Ext_TabBar.PROPERTIES()), events.concat(Ext_TabBar.EVENTS())) || this;
  }

  var _proto = Ext_TabBar.prototype;
