...
function (_Ext_d3_Component) {
  ...
  _createClass(Ext_d3_svg_Svg, null, [{
    ...
    get: function get() {
      var attrs = _Ext_d3_Component.observedAttributes; //for (var property in Ext_d3_svg_Svg.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
