...
var Ext_d3_ComponentBase =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_d3_ComponentBase, _Ext_Component);
  ...
  _createClass(Ext_d3_ComponentBase, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_d3_ComponentBase.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_d3_ComponentBase(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_d3_ComponentBase.PROPERTIES()), events.concat(Ext_d3_ComponentBase.EVENTS())) || this;
  }
