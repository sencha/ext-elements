...
function (_Ext_d3_hierarchy_Hie) {
  ...
  _createClass(Ext_d3_hierarchy_TreeMap, null, [{
    ...
    get: function get() {
      var attrs = _Ext_d3_hierarchy_Hie.observedAttributes; //for (var property in Ext_d3_hierarchy_TreeMap.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
