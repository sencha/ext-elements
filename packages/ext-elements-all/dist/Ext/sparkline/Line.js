...
function (_Ext_sparkline_Base) {
  ...
  _createClass(Ext_sparkline_Line, null, [{
    ...
    get: function get() {
      var attrs = _Ext_sparkline_Base.observedAttributes; //for (var property in Ext_sparkline_Line.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
