...
function (_Ext_Container) {
  _inheritsLoose(Ext_TabPanel, _Ext_Container);

  Ext_TabPanel.PROPERTIES = function PROPERTIES() {
  ...
  Ext_TabPanel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_TabPanel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_TabPanel.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_TabPanel.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_TabPanel, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_TabPanel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_TabPanel(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_TabPanel.PROPERTIES()), events.concat(Ext_TabPanel.EVENTS())) || this;
  }

  var _proto = Ext_TabPanel.prototype;
...
export { Ext_TabPanel as default };