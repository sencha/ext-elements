...
function (_Ext_Container) {
  _inheritsLoose(Ext_TitleBar, _Ext_Container);

  Ext_TitleBar.PROPERTIES = function PROPERTIES() {
  ...
  Ext_TitleBar.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_TitleBar.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_TitleBar.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_TitleBar.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_TitleBar, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_TitleBar.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_TitleBar.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_TitleBar.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_TitleBar(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_TitleBar.PROPERTIES()), events.concat(Ext_TitleBar.EVENTS())) || this;
  }

  var _proto = Ext_TitleBar.prototype;
...
export { Ext_TitleBar as default };