...
var Ext_lib_Container =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_lib_Container, _Ext_Component);

  Ext_lib_Container.PROPERTIES = function PROPERTIES() {
  ...
  Ext_lib_Container.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_lib_Container.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_lib_Container.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_lib_Container.getEvents = function getEvents(events) {
    events = events.concat(Ext_lib_Container.EVENTS());
  ...
  _createClass(Ext_lib_Container, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_lib_Container.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_lib_Container.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_lib_Container.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_lib_Container(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_lib_Container.PROPERTIES()), events.concat(Ext_lib_Container.EVENTS())) || this;
  }

  var _proto = Ext_lib_Container.prototype;
  ...
  return Ext_lib_Container;
}(Ext_Component);

export { Ext_lib_Container as default };