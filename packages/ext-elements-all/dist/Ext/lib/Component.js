...
var Ext_lib_Component =
/*#__PURE__*/
function (_Ext_Widget) {
  _inheritsLoose(Ext_lib_Component, _Ext_Widget);

  Ext_lib_Component.PROPERTIES = function PROPERTIES() {
  ...
  Ext_lib_Component.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_lib_Component.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_lib_Component.PROPERTIES());
    return Ext_Widget.getProperties(properties);
  };

  Ext_lib_Component.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_lib_Component, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Widget.observedAttributes; //for (var property in Ext_lib_Component.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_lib_Component(properties, events) {
    return _Ext_Widget.call(this, properties.concat(Ext_lib_Component.PROPERTIES()), events.concat(Ext_lib_Component.EVENTS())) || this;
  }

  var _proto = Ext_lib_Component.prototype;
  ...
  return Ext_lib_Component;
}(Ext_Widget);

export { Ext_lib_Component as default };