...
function (_Ext_Component) {
  _inheritsLoose(Ext_Img, _Ext_Component);

  Ext_Img.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Img.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_Img.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Img.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_Img.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_Img, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_Img.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_Img(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_Img.PROPERTIES()), events.concat(Ext_Img.EVENTS())) || this;
  }

  var _proto = Ext_Img.prototype;
