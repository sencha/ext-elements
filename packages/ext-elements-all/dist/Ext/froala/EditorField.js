...
function (_Ext_field_Container) {
  ...
  Ext_froala_EditorField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_froala_EditorField.PROPERTIES());
    return Ext_field_Container.getProperties(properties);
  };

  Ext_froala_EditorField.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_froala_EditorField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Container.observedAttributes; //for (var property in Ext_froala_EditorField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_froala_EditorField.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_froala_EditorField.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_froala_EditorField(properties, events) {
    return _Ext_field_Container.call(this, properties.concat(Ext_froala_EditorField.PROPERTIES()), events.concat(Ext_froala_EditorField.EVENTS())) || this;
  }

  var _proto = Ext_froala_EditorField.prototype;
...
export { Ext_froala_EditorField as default };