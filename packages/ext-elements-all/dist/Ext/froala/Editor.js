...
function (_Ext_Component) {
  ...
  Ext_froala_Editor.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_froala_Editor.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_froala_Editor.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_froala_Editor, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_froala_Editor.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_froala_Editor(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_froala_Editor.PROPERTIES()), events.concat(Ext_froala_Editor.EVENTS())) || this;
  }

  var _proto = Ext_froala_Editor.prototype;
...
export { Ext_froala_Editor as default };