...
function (_Ext_Component) {
  _inheritsLoose(Ext_Spacer, _Ext_Component);

  Ext_Spacer.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Spacer.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_Spacer.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_Spacer, null, [{
    ...
    get: function get() {
      ...
      Ext_Spacer.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Spacer(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_Spacer.PROPERTIES()), events.concat(Ext_Spacer.EVENTS())) || this;
  }

  var _proto = Ext_Spacer.prototype;
