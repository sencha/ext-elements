...
function (_Ext_Container) {
  _inheritsLoose(Ext_Carousel, _Ext_Container);

  Ext_Carousel.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Carousel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_Carousel.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_Carousel, null, [{
    ...
    get: function get() {
      ...
      Ext_Carousel.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Carousel(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_Carousel.PROPERTIES()), events.concat(Ext_Carousel.EVENTS())) || this;
  }

  var _proto = Ext_Carousel.prototype;
...
export { Ext_Carousel as default };