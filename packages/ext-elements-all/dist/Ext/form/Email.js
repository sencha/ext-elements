...
function (_Ext_field_Text) {
  _inheritsLoose(Ext_form_Email, _Ext_field_Text);

  Ext_form_Email.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_Email.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_form_Email.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Email.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_form_Email.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Email, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_form_Email.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_Email.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_Email.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_Email(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_form_Email.PROPERTIES()), events.concat(Ext_form_Email.EVENTS())) || this;
  }

  var _proto = Ext_form_Email.prototype;
...
export { Ext_form_Email as default };