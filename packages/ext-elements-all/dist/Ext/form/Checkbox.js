...
function (_Ext_field_Input) {
  ...
  Ext_form_Checkbox.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Checkbox.PROPERTIES());
    return Ext_field_Input.getProperties(properties);
  };

  Ext_form_Checkbox.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Checkbox, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Input.observedAttributes; //for (var property in Ext_form_Checkbox.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_Checkbox.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_Checkbox.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_Checkbox(properties, events) {
    return _Ext_field_Input.call(this, properties.concat(Ext_form_Checkbox.PROPERTIES()), events.concat(Ext_form_Checkbox.EVENTS())) || this;
  }

  var _proto = Ext_form_Checkbox.prototype;
...
export { Ext_form_Checkbox as default };