...
function (_Ext_field_Field) {
  _inheritsLoose(Ext_form_Slider, _Ext_field_Field);

  Ext_form_Slider.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_Slider.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_form_Slider.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Slider.PROPERTIES());
    return Ext_field_Field.getProperties(properties);
  };

  Ext_form_Slider.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Slider, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Field.observedAttributes; //for (var property in Ext_form_Slider.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_Slider.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_Slider.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_Slider(properties, events) {
    return _Ext_field_Field.call(this, properties.concat(Ext_form_Slider.PROPERTIES()), events.concat(Ext_form_Slider.EVENTS())) || this;
  }

  var _proto = Ext_form_Slider.prototype;
...
export { Ext_form_Slider as default };