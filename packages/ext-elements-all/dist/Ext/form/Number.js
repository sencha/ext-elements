...
function (_Ext_field_Text) {
  _inheritsLoose(Ext_form_Number, _Ext_field_Text);

  Ext_form_Number.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_Number.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_form_Number.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Number.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_form_Number.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Number, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_form_Number.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_Number.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_Number.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_Number(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_form_Number.PROPERTIES()), events.concat(Ext_form_Number.EVENTS())) || this;
  }

  var _proto = Ext_form_Number.prototype;
...
export { Ext_form_Number as default };