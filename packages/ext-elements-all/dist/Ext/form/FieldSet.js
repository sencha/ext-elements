...
function (_Ext_Container) {
  ...
  Ext_form_FieldSet.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_form_FieldSet, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_form_FieldSet.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
      ...
      Ext_form_FieldSet.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_FieldSet(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_form_FieldSet.PROPERTIES()), events.concat(Ext_form_FieldSet.EVENTS())) || this;
  }

  var _proto = Ext_form_FieldSet.prototype;
...
export { Ext_form_FieldSet as default };