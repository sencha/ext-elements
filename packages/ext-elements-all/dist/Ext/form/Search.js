...
function (_Ext_field_Text) {
  _inheritsLoose(Ext_form_Search, _Ext_field_Text);

  Ext_form_Search.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_Search.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_form_Search.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Search.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_form_Search.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Search, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_form_Search.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_Search.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_Search.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_Search(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_form_Search.PROPERTIES()), events.concat(Ext_form_Search.EVENTS())) || this;
  }

  var _proto = Ext_form_Search.prototype;
...
export { Ext_form_Search as default };