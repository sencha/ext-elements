...
var Ext_form_DatePicker =
/*#__PURE__*/
function (_Ext_field_Picker) {
  _inheritsLoose(Ext_form_DatePicker, _Ext_field_Picker);

  Ext_form_DatePicker.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_DatePicker.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_form_DatePicker.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_DatePicker.PROPERTIES());
    return Ext_field_Picker.getProperties(properties);
  };

  Ext_form_DatePicker.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_DatePicker, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Picker.observedAttributes; //for (var property in Ext_form_DatePicker.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_DatePicker.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_DatePicker.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_DatePicker(properties, events) {
    return _Ext_field_Picker.call(this, properties.concat(Ext_form_DatePicker.PROPERTIES()), events.concat(Ext_form_DatePicker.EVENTS())) || this;
  }

  var _proto = Ext_form_DatePicker.prototype;
  ...
  return Ext_form_DatePicker;
}(Ext_field_Picker);

export { Ext_form_DatePicker as default };