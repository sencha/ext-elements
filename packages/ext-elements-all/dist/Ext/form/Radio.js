...
function (_Ext_field_Checkbox) {
  ...
  Ext_form_Radio.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_form_Radio.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Radio.PROPERTIES());
    return Ext_field_Checkbox.getProperties(properties);
  };

  Ext_form_Radio.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Radio, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Checkbox.observedAttributes; //for (var property in Ext_form_Radio.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Radio(properties, events) {
    return _Ext_field_Checkbox.call(this, properties.concat(Ext_form_Radio.PROPERTIES()), events.concat(Ext_form_Radio.EVENTS())) || this;
  }

  var _proto = Ext_form_Radio.prototype;
...
export { Ext_form_Radio as default };