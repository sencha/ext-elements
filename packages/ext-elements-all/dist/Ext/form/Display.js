...
var Ext_form_Display =
/*#__PURE__*/
function (_Ext_field_Field) {
  _inheritsLoose(Ext_form_Display, _Ext_field_Field);
  ...
  _createClass(Ext_form_Display, null, [{
    ...
    get: function get() {
      var attrs = _Ext_field_Field.observedAttributes; //for (var property in Ext_form_Display.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Display(properties, events) {
    return _Ext_field_Field.call(this, properties.concat(Ext_form_Display.PROPERTIES()), events.concat(Ext_form_Display.EVENTS())) || this;
  }
