...
function (_Ext_field_Text) {
  _inheritsLoose(Ext_form_Url, _Ext_field_Text);

  Ext_form_Url.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_Url.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'sender,e'
    }, {
  ...
  Ext_form_Url.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Url.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_form_Url.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Url, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_form_Url.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_Url.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_Url.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_Url(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_form_Url.PROPERTIES()), events.concat(Ext_form_Url.EVENTS())) || this;
  }

  var _proto = Ext_form_Url.prototype;
...
export { Ext_form_Url as default };