...
function (_Ext_field_SingleSlid) {
  ...
  Ext_form_Toggle.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Toggle.PROPERTIES());
    return Ext_field_SingleSlider.getProperties(properties);
  };

  Ext_form_Toggle.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Toggle, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_SingleSlid.observedAttributes; //for (var property in Ext_form_Toggle.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Toggle(properties, events) {
    return _Ext_field_SingleSlid.call(this, properties.concat(Ext_form_Toggle.PROPERTIES()), events.concat(Ext_form_Toggle.EVENTS())) || this;
  }

  var _proto = Ext_form_Toggle.prototype;
...
export { Ext_form_Toggle as default };