...
function (_Ext_field_Text) {
  ...
  Ext_form_TextArea.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_TextArea.PROPERTIES());
    return Ext_field_Text.getProperties(properties);
  };

  Ext_form_TextArea.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_TextArea, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_field_Text.observedAttributes; //for (var property in Ext_form_TextArea.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_TextArea.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_TextArea.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_TextArea(properties, events) {
    return _Ext_field_Text.call(this, properties.concat(Ext_form_TextArea.PROPERTIES()), events.concat(Ext_form_TextArea.EVENTS())) || this;
  }

  var _proto = Ext_form_TextArea.prototype;
...
export { Ext_form_TextArea as default };