...
function (_Ext_Widget) {
  _inheritsLoose(Ext_Component, _Ext_Widget);

  Ext_Component.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Component.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_Component.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Component.PROPERTIES());
    return Ext_Widget.getProperties(properties);
  };

  Ext_Component.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_Component, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Widget.observedAttributes; //for (var property in Ext_Component.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_Component.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_Component.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Component(properties, events) {
    return _Ext_Widget.call(this, properties.concat(Ext_Component.PROPERTIES()), events.concat(Ext_Component.EVENTS())) || this;
  }

  var _proto = Ext_Component.prototype;
...
export { Ext_Component as default };