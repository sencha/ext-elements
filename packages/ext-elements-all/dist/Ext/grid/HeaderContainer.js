...
function (_Ext_Container) {
  ...
  _createClass(Ext_grid_HeaderContainer, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_grid_HeaderContainer.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
