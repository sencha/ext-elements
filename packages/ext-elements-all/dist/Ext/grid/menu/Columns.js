...
function (_Ext_grid_menu_Shared) {
  ...
  Ext_grid_menu_Columns.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_menu_Columns.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_grid_menu_Columns, null, [{
    ...
    get: function get() {
      ...
      Ext_grid_menu_Columns.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_menu_Columns(properties, events) {
    return _Ext_grid_menu_Shared.call(this, properties.concat(Ext_grid_menu_Columns.PROPERTIES()), events.concat(Ext_grid_menu_Columns.EVENTS())) || this;
  }

  var _proto = Ext_grid_menu_Columns.prototype;
...
export { Ext_grid_menu_Columns as default };