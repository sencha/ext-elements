...
function (_Ext_menu_Item) {
  ...
  Ext_grid_menu_GroupByThis.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_menu_GroupByThis.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_grid_menu_GroupByThis, null, [{
    ...
    get: function get() {
      ...
      Ext_grid_menu_GroupByThis.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_menu_GroupByThis(properties, events) {
    return _Ext_menu_Item.call(this, properties.concat(Ext_grid_menu_GroupByThis.PROPERTIES()), events.concat(Ext_grid_menu_GroupByThis.EVENTS())) || this;
  }

  var _proto = Ext_grid_menu_GroupByThis.prototype;
...
export { Ext_grid_menu_GroupByThis as default };