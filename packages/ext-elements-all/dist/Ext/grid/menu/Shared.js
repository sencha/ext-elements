...
var Ext_grid_menu_Shared =
/*#__PURE__*/
function (_Ext_menu_Item) {
  _inheritsLoose(Ext_grid_menu_Shared, _Ext_menu_Item);

  Ext_grid_menu_Shared.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_menu_Shared.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_menu_Shared.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_menu_Shared.PROPERTIES());
    return Ext_menu_Item.getProperties(properties);
  };

  Ext_grid_menu_Shared.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_menu_Shared, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_menu_Item.observedAttributes; //for (var property in Ext_grid_menu_Shared.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_menu_Shared.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_menu_Shared.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_menu_Shared(properties, events) {
    return _Ext_menu_Item.call(this, properties.concat(Ext_grid_menu_Shared.PROPERTIES()), events.concat(Ext_grid_menu_Shared.EVENTS())) || this;
  }

  var _proto = Ext_grid_menu_Shared.prototype;
...
export { Ext_grid_menu_Shared as default };