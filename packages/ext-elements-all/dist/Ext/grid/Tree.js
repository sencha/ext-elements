...
function (_Ext_grid_Grid) {
  ...
  Ext_grid_Tree.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_Tree.PROPERTIES());
    return Ext_grid_Grid.getProperties(properties);
  };

  Ext_grid_Tree.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_Tree, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_Grid.observedAttributes; //for (var property in Ext_grid_Tree.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_Tree.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_Tree.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_Tree(properties, events) {
    return _Ext_grid_Grid.call(this, properties.concat(Ext_grid_Tree.PROPERTIES()), events.concat(Ext_grid_Tree.EVENTS())) || this;
  }

  var _proto = Ext_grid_Tree.prototype;
  ...
  return Ext_grid_Tree;
}(Ext_grid_Grid);

export { Ext_grid_Tree as default };