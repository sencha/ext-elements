...
var Ext_grid_RowBody =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_grid_RowBody, _Ext_Component);

  Ext_grid_RowBody.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_RowBody.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_RowBody.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_RowBody.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_grid_RowBody.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_RowBody, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_grid_RowBody.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_grid_RowBody(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_grid_RowBody.PROPERTIES()), events.concat(Ext_grid_RowBody.EVENTS())) || this;
  }

  var _proto = Ext_grid_RowBody.prototype;
...
export { Ext_grid_RowBody as default };