...
function (_Ext_grid_column_Numb) {
  ...
  Ext_grid_column_RowNumberer.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_grid_column_RowNumberer.getProperties = function getProperties(properties) {
  ...
  Ext_grid_column_RowNumberer.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_column_RowNumberer, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Numb.observedAttributes; //for (var property in Ext_grid_column_RowNumberer.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_column_RowNumberer.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_column_RowNumberer.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_column_RowNumberer(properties, events) {
    return _Ext_grid_column_Numb.call(this, properties.concat(Ext_grid_column_RowNumberer.PROPERTIES()), events.concat(Ext_grid_column_RowNumberer.EVENTS())) || this;
  }

  var _proto = Ext_grid_column_RowNumberer.prototype;
...
export { Ext_grid_column_RowNumberer as default };