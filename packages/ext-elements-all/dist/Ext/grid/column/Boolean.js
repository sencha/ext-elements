...
function (_Ext_grid_column_Colu) {
  ...
  Ext_grid_column_Boolean.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_column_Boolean.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_column_Boolean.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_column_Boolean, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_column_Boolean.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_grid_column_Boolean(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_column_Boolean.PROPERTIES()), events.concat(Ext_grid_column_Boolean.EVENTS())) || this;
  }

  var _proto = Ext_grid_column_Boolean.prototype;
...
export { Ext_grid_column_Boolean as default };