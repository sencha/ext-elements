...
var Ext_grid_column_Column =
/*#__PURE__*/
function (_Ext_grid_HeaderConta) {
  _inheritsLoose(Ext_grid_column_Column, _Ext_grid_HeaderConta);
  ...
  _createClass(Ext_grid_column_Column, null, [{
    ...
    get: function get() {
      var attrs = _Ext_grid_HeaderConta.observedAttributes; //for (var property in Ext_grid_column_Column.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_grid_column_Column(properties, events) {
    return _Ext_grid_HeaderConta.call(this, properties.concat(Ext_grid_column_Column.PROPERTIES()), events.concat(Ext_grid_column_Column.EVENTS())) || this;
  }
