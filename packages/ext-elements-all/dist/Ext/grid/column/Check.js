...
var Ext_grid_column_Check =
/*#__PURE__*/
function (_Ext_grid_column_Colu) {
  _inheritsLoose(Ext_grid_column_Check, _Ext_grid_column_Colu);

  Ext_grid_column_Check.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_column_Check.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_grid_column_Check.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_column_Check.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_column_Check.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_column_Check, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_column_Check.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_grid_column_Check(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_column_Check.PROPERTIES()), events.concat(Ext_grid_column_Check.EVENTS())) || this;
  }

  var _proto = Ext_grid_column_Check.prototype;
...
export { Ext_grid_column_Check as default };