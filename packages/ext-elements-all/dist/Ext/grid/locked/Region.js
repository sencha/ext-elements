...
var Ext_grid_locked_Region =
/*#__PURE__*/
function (_Ext_Panel) {
  _inheritsLoose(Ext_grid_locked_Region, _Ext_Panel);

  Ext_grid_locked_Region.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_locked_Region.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_grid_locked_Region.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_grid_locked_Region, null, [{
    ...
    get: function get() {
      ...
      Ext_grid_locked_Region.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_locked_Region(properties, events) {
    return _Ext_Panel.call(this, properties.concat(Ext_grid_locked_Region.PROPERTIES()), events.concat(Ext_grid_locked_Region.EVENTS())) || this;
  }

  var _proto = Ext_grid_locked_Region.prototype;
  ...
  return Ext_grid_locked_Region;
}(Ext_Panel);

export { Ext_grid_locked_Region as default };