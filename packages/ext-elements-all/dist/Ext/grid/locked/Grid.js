...
var Ext_grid_locked_Grid =
/*#__PURE__*/
function (_Ext_Panel) {
  _inheritsLoose(Ext_grid_locked_Grid, _Ext_Panel);

  Ext_grid_locked_Grid.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_locked_Grid.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_grid_locked_Grid.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_locked_Grid.PROPERTIES());
    return Ext_Panel.getProperties(properties);
  };

  Ext_grid_locked_Grid.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_locked_Grid.EVENTS());
  ...
  _createClass(Ext_grid_locked_Grid, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Panel.observedAttributes; //for (var property in Ext_grid_locked_Grid.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_locked_Grid.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_locked_Grid.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_locked_Grid(properties, events) {
    return _Ext_Panel.call(this, properties.concat(Ext_grid_locked_Grid.PROPERTIES()), events.concat(Ext_grid_locked_Grid.EVENTS())) || this;
  }

  var _proto = Ext_grid_locked_Grid.prototype;
  ...
  return Ext_grid_locked_Grid;
}(Ext_Panel);

export { Ext_grid_locked_Grid as default };