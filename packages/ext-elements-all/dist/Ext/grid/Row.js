...
function (_Ext_Component) {
  _inheritsLoose(Ext_grid_Row, _Ext_Component);

  Ext_grid_Row.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_Row.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_Row.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_Row.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_grid_Row.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_Row, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_grid_Row.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_Row.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_Row.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_Row(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_grid_Row.PROPERTIES()), events.concat(Ext_grid_Row.EVENTS())) || this;
  }

  var _proto = Ext_grid_Row.prototype;
...
export { Ext_grid_Row as default };