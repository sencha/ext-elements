...
var Ext_grid_rowedit_Editor =
/*#__PURE__*/
function (_Ext_dataview_ListIte) {
  _inheritsLoose(Ext_grid_rowedit_Editor, _Ext_dataview_ListIte);

  Ext_grid_rowedit_Editor.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_rowedit_Editor.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_grid_rowedit_Editor.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_rowedit_Editor.PROPERTIES());
    return Ext_dataview_ListItem.getProperties(properties);
  };

  Ext_grid_rowedit_Editor.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_rowedit_Editor, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_dataview_ListIte.observedAttributes; //for (var property in Ext_grid_rowedit_Editor.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_grid_rowedit_Editor(properties, events) {
    return _Ext_dataview_ListIte.call(this, properties.concat(Ext_grid_rowedit_Editor.PROPERTIES()), events.concat(Ext_grid_rowedit_Editor.EVENTS())) || this;
  }

  var _proto = Ext_grid_rowedit_Editor.prototype;
...
export { Ext_grid_rowedit_Editor as default };