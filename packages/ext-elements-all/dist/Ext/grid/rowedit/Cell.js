...
var Ext_grid_rowedit_Cell =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_grid_rowedit_Cell, _Ext_Component);

  Ext_grid_rowedit_Cell.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_rowedit_Cell.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_rowedit_Cell.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_grid_rowedit_Cell, null, [{
    ...
    get: function get() {
      ...
      Ext_grid_rowedit_Cell.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_rowedit_Cell(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_grid_rowedit_Cell.PROPERTIES()), events.concat(Ext_grid_rowedit_Cell.EVENTS())) || this;
  }

  var _proto = Ext_grid_rowedit_Cell.prototype;
...
export { Ext_grid_rowedit_Cell as default };