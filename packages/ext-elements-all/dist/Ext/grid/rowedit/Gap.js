...
var Ext_grid_rowedit_Gap =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_grid_rowedit_Gap, _Ext_Component);

  Ext_grid_rowedit_Gap.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_rowedit_Gap.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_rowedit_Gap.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_rowedit_Gap.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_grid_rowedit_Gap.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_rowedit_Gap, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_grid_rowedit_Gap.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_rowedit_Gap.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_rowedit_Gap.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_rowedit_Gap(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_grid_rowedit_Gap.PROPERTIES()), events.concat(Ext_grid_rowedit_Gap.EVENTS())) || this;
  }

  var _proto = Ext_grid_rowedit_Gap.prototype;
...
export { Ext_grid_rowedit_Gap as default };