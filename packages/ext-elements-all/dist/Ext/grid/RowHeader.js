...
function (_Ext_dataview_ItemHea) {
  ...
  Ext_grid_RowHeader.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_grid_RowHeader.getProperties = function getProperties(properties) {
  ...
  function Ext_grid_RowHeader(properties, events) {
    return _Ext_dataview_ItemHea.call(this, properties.concat(Ext_grid_RowHeader.PROPERTIES()), events.concat(Ext_grid_RowHeader.EVENTS())) || this;
  }

  var _proto = Ext_grid_RowHeader.prototype;
...
export { Ext_grid_RowHeader as default };