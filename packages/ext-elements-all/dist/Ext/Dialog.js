...
/*#__PURE__*/
function (_Ext_Panel) {
  _inheritsLoose(Ext_Dialog, _Ext_Panel);

  Ext_Dialog.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Dialog.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_Dialog.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_Dialog, null, [{
    ...
    get: function get() {
      ...
      Ext_Dialog.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Dialog(properties, events) {
    return _Ext_Panel.call(this, properties.concat(Ext_Dialog.PROPERTIES()), events.concat(Ext_Dialog.EVENTS())) || this;
  }

  var _proto = Ext_Dialog.prototype;
