...
var Ext_chart_navigator_ContainerBase =
/*#__PURE__*/
function (_Ext_Container) {
  _inheritsLoose(Ext_chart_navigator_ContainerBase, _Ext_Container);

  Ext_chart_navigator_ContainerBase.PROPERTIES = function PROPERTIES() {
  ...
  Ext_chart_navigator_ContainerBase.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_chart_navigator_ContainerBase.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_chart_navigator_ContainerBase.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_chart_navigator_ContainerBase.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_chart_navigator_ContainerBase, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_chart_navigator_ContainerBase.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_chart_navigator_ContainerBase.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_chart_navigator_ContainerBase.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_chart_navigator_ContainerBase(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_chart_navigator_ContainerBase.PROPERTIES()), events.concat(Ext_chart_navigator_ContainerBase.EVENTS())) || this;
  }

  var _proto = Ext_chart_navigator_ContainerBase.prototype;
...
export { Ext_chart_navigator_ContainerBase as default };