...
var Ext_chart_legend_LegendBase =
/*#__PURE__*/
function (_Ext_dataview_DataVie) {
  _inheritsLoose(Ext_chart_legend_LegendBase, _Ext_dataview_DataVie);

  Ext_chart_legend_LegendBase.PROPERTIES = function PROPERTIES() {
  ...
  Ext_chart_legend_LegendBase.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_chart_legend_LegendBase.getProperties = function getProperties(properties) {
  ...
  function Ext_chart_legend_LegendBase(properties, events) {
    return _Ext_dataview_DataVie.call(this, properties.concat(Ext_chart_legend_LegendBase.PROPERTIES()), events.concat(Ext_chart_legend_LegendBase.EVENTS())) || this;
  }

  var _proto = Ext_chart_legend_LegendBase.prototype;
...
export { Ext_chart_legend_LegendBase as default };