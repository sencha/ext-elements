...
var Ext_chart_legend_Legend =
/*#__PURE__*/
function (_Ext_chart_legend_Leg) {
  _inheritsLoose(Ext_chart_legend_Legend, _Ext_chart_legend_Leg);

  Ext_chart_legend_Legend.PROPERTIES = function PROPERTIES() {
  ...
  Ext_chart_legend_Legend.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_chart_legend_Legend.getProperties = function getProperties(properties) {
  ...
  Ext_chart_legend_Legend.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_chart_legend_Legend, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_chart_legend_Leg.observedAttributes; //for (var property in Ext_chart_legend_Legend.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_chart_legend_Legend.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_chart_legend_Legend.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_chart_legend_Legend(properties, events) {
    return _Ext_chart_legend_Leg.call(this, properties.concat(Ext_chart_legend_Legend.PROPERTIES()), events.concat(Ext_chart_legend_Legend.EVENTS())) || this;
  }

  var _proto = Ext_chart_legend_Legend.prototype;
  ...
  return Ext_chart_legend_Legend;
}(Ext_chart_legend_LegendBase);

export { Ext_chart_legend_Legend as default };