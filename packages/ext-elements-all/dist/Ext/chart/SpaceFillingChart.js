...
var Ext_chart_SpaceFillingChart =
/*#__PURE__*/
function (_Ext_chart_AbstractCh) {
  _inheritsLoose(Ext_chart_SpaceFillingChart, _Ext_chart_AbstractCh);

  Ext_chart_SpaceFillingChart.PROPERTIES = function PROPERTIES() {
  ...
  Ext_chart_SpaceFillingChart.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_chart_SpaceFillingChart.getProperties = function getProperties(properties) {
  ...
  Ext_chart_SpaceFillingChart.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_chart_SpaceFillingChart, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_chart_AbstractCh.observedAttributes; //for (var property in Ext_chart_SpaceFillingChart.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_chart_SpaceFillingChart(properties, events) {
    return _Ext_chart_AbstractCh.call(this, properties.concat(Ext_chart_SpaceFillingChart.PROPERTIES()), events.concat(Ext_chart_SpaceFillingChart.EVENTS())) || this;
  }

  var _proto = Ext_chart_SpaceFillingChart.prototype;
...
export { Ext_chart_SpaceFillingChart as default };