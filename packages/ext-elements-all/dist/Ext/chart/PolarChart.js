...
function (_Ext_chart_AbstractCh) {
  ...
  Ext_chart_PolarChart.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_chart_PolarChart.PROPERTIES());
    return Ext_chart_AbstractChart.getProperties(properties);
  };

  Ext_chart_PolarChart.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_chart_PolarChart, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_chart_AbstractCh.observedAttributes; //for (var property in Ext_chart_PolarChart.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_chart_PolarChart.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_chart_PolarChart.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_chart_PolarChart(properties, events) {
    return _Ext_chart_AbstractCh.call(this, properties.concat(Ext_chart_PolarChart.PROPERTIES()), events.concat(Ext_chart_PolarChart.EVENTS())) || this;
  }

  var _proto = Ext_chart_PolarChart.prototype;
...
export { Ext_chart_PolarChart as default };