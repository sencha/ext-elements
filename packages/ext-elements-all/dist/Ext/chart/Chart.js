...
function (_Ext_chart_AbstractCh) {
  _inheritsLoose(Ext_chart_Chart, _Ext_chart_AbstractCh);

  Ext_chart_Chart.PROPERTIES = function PROPERTIES() {
  ...
  Ext_chart_Chart.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_chart_Chart.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_chart_Chart.PROPERTIES());
    return Ext_chart_AbstractChart.getProperties(properties);
  };

  Ext_chart_Chart.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_chart_Chart, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_chart_AbstractCh.observedAttributes; //for (var property in Ext_chart_Chart.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_chart_Chart(properties, events) {
    return _Ext_chart_AbstractCh.call(this, properties.concat(Ext_chart_Chart.PROPERTIES()), events.concat(Ext_chart_Chart.EVENTS())) || this;
  }

  var _proto = Ext_chart_Chart.prototype;
...
export { Ext_chart_Chart as default };