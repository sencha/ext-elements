...
var Ext_draw_ContainerBase =
/*#__PURE__*/
function (_Ext_Container) {
  _inheritsLoose(Ext_draw_ContainerBase, _Ext_Container);

  Ext_draw_ContainerBase.PROPERTIES = function PROPERTIES() {
  ...
  Ext_draw_ContainerBase.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_draw_ContainerBase.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_draw_ContainerBase.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_draw_ContainerBase.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_draw_ContainerBase, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_draw_ContainerBase.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_draw_ContainerBase.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_draw_ContainerBase.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_draw_ContainerBase(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_draw_ContainerBase.PROPERTIES()), events.concat(Ext_draw_ContainerBase.EVENTS())) || this;
  }

  var _proto = Ext_draw_ContainerBase.prototype;
...
export { Ext_draw_ContainerBase as default };