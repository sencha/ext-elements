...
var Ext_draw_Container =
/*#__PURE__*/
function (_Ext_draw_ContainerBa) {
  _inheritsLoose(Ext_draw_Container, _Ext_draw_ContainerBa);

  Ext_draw_Container.PROPERTIES = function PROPERTIES() {
  ...
  Ext_draw_Container.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_draw_Container.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_draw_Container.PROPERTIES());
    return Ext_draw_ContainerBase.getProperties(properties);
  };

  Ext_draw_Container.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_draw_Container, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_draw_ContainerBa.observedAttributes; //for (var property in Ext_draw_Container.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_draw_Container(properties, events) {
    return _Ext_draw_ContainerBa.call(this, properties.concat(Ext_draw_Container.PROPERTIES()), events.concat(Ext_draw_Container.EVENTS())) || this;
  }

  var _proto = Ext_draw_Container.prototype;
...
export { Ext_draw_Container as default };