...
function (_Ext_Container) {
  ...
  Ext_NestedList.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_NestedList.PROPERTIES());
    return Ext_Container.getProperties(properties);
  };

  Ext_NestedList.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_NestedList, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Container.observedAttributes; //for (var property in Ext_NestedList.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_NestedList(properties, events) {
    return _Ext_Container.call(this, properties.concat(Ext_NestedList.PROPERTIES()), events.concat(Ext_NestedList.EVENTS())) || this;
  }

  var _proto = Ext_NestedList.prototype;
...
export { Ext_NestedList as default };