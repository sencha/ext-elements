...
var Ext_picker_Tablet =
/*#__PURE__*/
function (_Ext_Panel) {
  _inheritsLoose(Ext_picker_Tablet, _Ext_Panel);

  Ext_picker_Tablet.PROPERTIES = function PROPERTIES() {
  ...
  Ext_picker_Tablet.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_picker_Tablet.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_picker_Tablet, null, [{
    ...
    get: function get() {
      ...
      Ext_picker_Tablet.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_picker_Tablet(properties, events) {
    return _Ext_Panel.call(this, properties.concat(Ext_picker_Tablet.PROPERTIES()), events.concat(Ext_picker_Tablet.EVENTS())) || this;
  }

  var _proto = Ext_picker_Tablet.prototype;
...
export { Ext_picker_Tablet as default };