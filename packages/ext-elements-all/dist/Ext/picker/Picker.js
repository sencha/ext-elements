...
var Ext_picker_Picker =
/*#__PURE__*/
function (_Ext_Sheet) {
  _inheritsLoose(Ext_picker_Picker, _Ext_Sheet);

  Ext_picker_Picker.PROPERTIES = function PROPERTIES() {
  ...
  Ext_picker_Picker.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_picker_Picker.getProperties = function getProperties(properties) {
  ...
  function Ext_picker_Picker(properties, events) {
    return _Ext_Sheet.call(this, properties.concat(Ext_picker_Picker.PROPERTIES()), events.concat(Ext_picker_Picker.EVENTS())) || this;
  }

  var _proto = Ext_picker_Picker.prototype;
...
export { Ext_picker_Picker as default };